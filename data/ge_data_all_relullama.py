...
model_path = "/data/shared_workspace/fujingkai/models/models--SparseLLM--ReluLLaMA-7B"
tokenizer_path = "/data/shared_workspace/fujingkai/models/models--SparseLLM--ReluLLaMA-7B"
    ...
    def preprocess_function(examples):
        ...
        for i in range(len(examples['id'])):
            ...
            if len(input_ids) > 4000:
                #print("skipping since input ids are too long, this shouldn't happen very often")
                continue
            ...
            loss_mask[cur_len+1:] = 0

            cur_len += 2 #all the above fixes come from https://github.com/lm-sys/FastChat/pull/2423/commits/7475455bbaec5870f60fdb25b99e04a0c05dcff0
...
bigmodel.eval()
#for param in bigmodel.parameters():
